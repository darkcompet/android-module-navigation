...
public class DkFragmentNavigator {
	...
	//todo it will not leak? long-live one should call short-live one.
	...
	public boolean handleOnBackPressed() {
		...
		// Notify the event to last child fragment
		if (lastChild instanceof TheFragment) {
			return ((TheFragment) lastChild).onBackPressed();
		}
	...
	public void restoreInstanceState(@Nullable Bundle in) {
		if (in != null) {
			MyTagManager.TagsParcelable tags = in.getParcelable("DkFragmentNavigator.tags");
